import node_vert from '../wgsl/node_vert.wgsl';
import node_frag from '../wgsl/node_frag.wgsl';
import edge_vert from '../wgsl/edge_vert.wgsl';
import edge_frag from '../wgsl/edge_frag.wgsl';
...
class Renderer {
  ...
  constructor(device: GPUDevice, canvasRef: any) {
    this.device = device;
  ...
  async runForceDirected() {
    this.forceDirected!.runForces(
      ...
      this.coolingFactor, this.idealLength, 10000, 100,
